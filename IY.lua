-- all credits to the owners, i dont own IY.
...
local Theme = {
	...
	AccentDim = Color3.fromRGB(60, 70, 180),
...
local function applyPadding(parent, t, b, l, r)
...
local function applyListLayout(parent, padding, dir, hAlign, vAlign, sortOrder)
...
local function makeButton(text, size, pos, parent, accent)
	local btn = Instance.new("TextButton")
	btn.Name = text
	btn.Parent = parent
	btn.BackgroundColor3 = accent and Theme.Accent or Theme.Elevated
	...
	btn.ZIndex = 10
	applyCorner(btn, Theme.CornerSmall)
	if not accent then
		applyStroke(btn, Theme.Border, 1)
	end
	btn.MouseEnter:Connect(function()
		tween(btn, TInfo.Fast, {BackgroundColor3 = accent and Theme.AccentHover or Theme.Border})
	end)
	btn.MouseLeave:Connect(function()
		tween(btn, TInfo.Fast, {BackgroundColor3 = accent and Theme.Accent or Theme.Elevated})
	end)
	table.insert(accent and shade3 or shade2, btn)
	table.insert(text1, btn)
	return btn
end

local function makeToggle(default, parent, pos, callback)
	local toggled = default or false
	local holder = Instance.new("Frame")
	holder.Name = "ToggleHolder"
	holder.Parent = parent
	holder.BackgroundColor3 = toggled and Theme.Accent or Theme.Elevated
	holder.BorderSizePixel = 0
	holder.Size = UDim2.new(0, 36, 0, 20)
	holder.Position = pos or UDim2.new(0, 0, 0, 0)
	holder.ZIndex = 10
	applyCorner(holder, UDim.new(0, 10))
	applyStroke(holder, Theme.Border, 1)
	...
	knob.Position = toggled and UDim2.new(1, -17, 0, 3) or UDim2.new(0, 3, 0, 3)
	knob.ZIndex = 11
	...
	btn.MouseButton1Click:Connect(function()
		toggled = not toggled
		tween(holder, TInfo.Normal, {BackgroundColor3 = toggled and Theme.Accent or Theme.Elevated})
		tween(knob, TInfo.Smooth, {Position = toggled and UDim2.new(1, -17, 0, 3) or UDim2.new(0, 3, 0, 3)})
		if callback then callback(toggled) end
	end)

	return holder, function() return toggled end, function(v)
		toggled = v
		tween(holder, TInfo.Normal, {BackgroundColor3 = toggled and Theme.Accent or Theme.Elevated})
		tween(knob, TInfo.Smooth, {Position = toggled and UDim2.new(1, -17, 0, 3) or UDim2.new(0, 3, 0, 3)})
	end
...
local function makeSlider(min, max, default, parent, pos, size, callback)
	local value = default or min
	local holder = Instance.new("Frame")
	holder.Name = "SliderHolder"
	holder.Parent = parent
	holder.BackgroundColor3 = Theme.Elevated
	holder.BorderSizePixel = 0
	holder.Size = size or UDim2.new(1, -10, 0, 6)
	holder.Position = pos or UDim2.new(0, 5, 0, 0)
	holder.ZIndex = 10
	applyCorner(holder, UDim.new(1, 0))
	...
	label.Position = UDim2.new((value - min) / (max - min), 0, 0, -20)
	...
	local function update(input)
		local relX = math.clamp((input.Position.X - holder.AbsolutePosition.X) / holder.AbsoluteSize.X, 0, 1)
		value = math.floor(min + (max - min) * relX)
		fill.Size = UDim2.new(relX, 0, 1, 0)
		knob.Position = UDim2.new(relX, 0, 0.5, 0)
		label.Position = UDim2.new(relX, 0, 0, -20)
		label.Text = tostring(value)
		if callback then callback(value) end
	end

	local inputBtn = Instance.new("TextButton")
	inputBtn.Name = "SliderInput"
	inputBtn.Parent = holder
	inputBtn.BackgroundTransparency = 1
	inputBtn.Size = UDim2.new(1, 0, 1, 10)
	inputBtn.Position = UDim2.new(0, 0, 0, -5)
	inputBtn.Text = ""
	inputBtn.ZIndex = 14
	...
	return holder, function() return value end, function(v)
...
local function makeDropdown(options, default, parent, pos, size, callback)
	...
	holder.BackgroundColor3 = Theme.Elevated
	holder.BorderSizePixel = 0
	holder.Size = size or UDim2.new(1, -10, 0, 28)
	holder.Position = pos or UDim2.new(0, 5, 0, 0)
	holder.ClipsDescendants = true
	holder.ZIndex = 15
	applyCorner(holder, Theme.CornerSmall)
	applyStroke(holder, Theme.Border, 1)
	...
	for _, opt in ipairs(options) do
		...
		optBtn.MouseEnter:Connect(function()
			tween(optBtn, TInfo.Fast, {BackgroundColor3 = Theme.Elevated, TextColor3 = Theme.Text})
		end)
		optBtn.MouseLeave:Connect(function()
			tween(optBtn, TInfo.Fast, {BackgroundColor3 = Theme.Surface, TextColor3 = Theme.TextDim})
		end)
		optBtn.MouseButton1Click:Connect(function()
			selected = opt
			display.Text = "  " .. opt
			open = false
			tween(holder, TInfo.Normal, {Size = UDim2.new(holder.Size.X.Scale, holder.Size.X.Offset, 0, 28)})
			tween(arrow, TInfo.Fast, {Rotation = 0})
	...
	display.MouseButton1Click:Connect(function()
		open = not open
		local targetH = open and (28 + #options * 26) or 28
		tween(holder, TInfo.Normal, {Size = UDim2.new(holder.Size.X.Scale, holder.Size.X.Offset, 0, targetH)})
		tween(arrow, TInfo.Fast, {Rotation = open and 180 or 0})
	end)

	return holder, function() return selected end, function(v)
		selected = v
		display.Text = "  " .. v
	end
end

local function makeSearchBar(parent, pos, size, placeholder, callback)
	local holder = Instance.new("Frame")
	holder.Name = "SearchBar"
	holder.Parent = parent
	holder.BackgroundColor3 = Theme.Elevated
	holder.BorderSizePixel = 0
	holder.Size = size or UDim2.new(1, -10, 0, 30)
	holder.Position = pos or UDim2.new(0, 5, 0, 0)
	holder.ZIndex = 10
	applyCorner(holder, Theme.CornerSmall)
	applyStroke(holder, Theme.Border, 1)
	...
	box.Focused:Connect(function()
		tween(holder, TInfo.Fast, {BackgroundColor3 = Theme.Surface})
		local stroke = holder:FindFirstChildWhichIsA("UIStroke")
		if stroke then tween(stroke, TInfo.Fast, {Color = Theme.Accent}) end
	end)

	box.FocusLost:Connect(function()
		tween(holder, TInfo.Fast, {BackgroundColor3 = Theme.Elevated})
		local stroke = holder:FindFirstChildWhichIsA("UIStroke")
		if stroke then tween(stroke, TInfo.Fast, {Color = Theme.Border}) end
	end)

	return holder, box
end

local function makeColorPicker(default, parent, pos, callback)
	local currentColor = default or Color3.fromRGB(88, 101, 242)
	...
	applyCorner(holder, Theme.Corner)
	applyStroke(holder, Theme.Border, 1)
	...
	applyCorner(svBox, Theme.CornerSmall)
	...
	svCursor.ZIndex = 22
	applyCorner(svCursor, UDim.new(1, 0))
	applyStroke(svCursor, Color3.new(0, 0, 0), 2)
	...
	applyCorner(hueBar, Theme.CornerSmall)
	...
	hueCursor.ZIndex = 22
	applyCorner(hueCursor, UDim.new(1, 0))
	...
	preview.Position = UDim2.new(0, 8, 0, 136)
	preview.Size = UDim2.new(0, 164, 0, 16)
	preview.ZIndex = 21
	applyCorner(preview, Theme.CornerSmall)
	...
	return holder, function() return currentColor end, function(c)
		currentColor = c
		h, s, v = c:ToHSV()
		updateColor()
	end
...
local function makeTabs(names, parent, pos, contentSize, callbacks)
	local holder = Instance.new("Frame")
	holder.Name = "TabsHolder"
	holder.Parent = parent
	...
	bar.ZIndex = 10
	applyCorner(bar, Theme.CornerSmall)
	applyListLayout(bar, 2, Enum.FillDirection.Horizontal)
	applyPadding(bar, 2, 2, 4, 4)
	...
	contentHolder.Size = contentSize or UDim2.new(1, 0, 0, 200)
	...
	for i, name in ipairs(names) do
		...
		tabBtn.Name = name
		tabBtn.Parent = bar
		tabBtn.BackgroundColor3 = i == 1 and Theme.Accent or Theme.Elevated
		tabBtn.BorderSizePixel = 0
		tabBtn.Size = UDim2.new(1 / #names, -6, 1, -4)
		tabBtn.Font = Theme.Font
		tabBtn.TextSize = 12
		tabBtn.TextColor3 = i == 1 and Theme.Text or Theme.TextDim
		tabBtn.Text = name
		tabBtn.AutoButtonColor = false
		tabBtn.ZIndex = 11
		applyCorner(tabBtn, Theme.CornerSmall)
		buttons[i] = tabBtn
		...
		tabBtn.MouseButton1Click:Connect(function()
			for j, b in ipairs(buttons) do
				local isActive = j == i
				tween(b, TInfo.Fast, {
					BackgroundColor3 = isActive and Theme.Accent or Theme.Elevated,
					TextColor3 = isActive and Theme.Text or Theme.TextDim,
				})
				pages[j].Visible = isActive
			end
			activeTab = i
			if callbacks and callbacks[i] then callbacks[i]() end
		end)
	end

	return holder, pages, function() return activeTab end
end
...
Holder.BackgroundColor3 = Theme.Surface
Holder.BorderSizePixel = 0
Holder.Position = UDim2.new(1, -270, 1, -240)
Holder.Size = UDim2.new(0, 260, 0, 235)
Holder.ZIndex = 10
applyCorner(Holder, Theme.Corner)
applyStroke(Holder, Theme.Border, 1)
...
TitleBar.ZIndex = 10
applyCorner(TitleBar, Theme.Corner)
table.insert(shade1, TitleBar)

local TitleBarBottom = Instance.new("Frame")
TitleBarBottom.Name = "BottomFill"
TitleBarBottom.Parent = TitleBar
TitleBarBottom.BackgroundColor3 = Theme.Bg
TitleBarBottom.BorderSizePixel = 0
TitleBarBottom.Position = UDim2.new(0, 0, 0, 20)
TitleBarBottom.Size = UDim2.new(1, 0, 0, 12)
TitleBarBottom.ZIndex = 10
table.insert(shade1, TitleBarBottom)
...
AccentDot.Position = UDim2.new(0, 4, 0, 12)
AccentDot.Size = UDim2.new(0, 4, 0, 8)
AccentDot.ZIndex = 11
applyCorner(AccentDot, UDim.new(1, 0))

SettingsButton = Instance.new("ImageButton")
SettingsButton.Name = "SettingsButton"
SettingsButton.Parent = TitleBar
SettingsButton.BackgroundTransparency = 1
SettingsButton.Position = UDim2.new(1, -56, 0, 6)
...
SettingsButton.MouseEnter:Connect(function()
	tween(SettingsButton, TInfo.Fast, {ImageColor3 = Theme.Text})
end)
SettingsButton.MouseLeave:Connect(function()
	tween(SettingsButton, TInfo.Fast, {ImageColor3 = Theme.TextDim})
end)

ReferenceButton = Instance.new("ImageButton")
ReferenceButton.Name = "ReferenceButton"
ReferenceButton.Parent = TitleBar
ReferenceButton.BackgroundTransparency = 1
ReferenceButton.Position = UDim2.new(1, -32, 0, 6)
ReferenceButton.Size = UDim2.new(0, 20, 0, 20)
ReferenceButton.Image = "rbxassetid://3523243755"
ReferenceButton.ImageColor3 = Theme.TextDim
ReferenceButton.ZIndex = 11

ReferenceButton.MouseEnter:Connect(function()
	tween(ReferenceButton, TInfo.Fast, {ImageColor3 = Theme.Text})
end)
ReferenceButton.MouseLeave:Connect(function()
	tween(ReferenceButton, TInfo.Fast, {ImageColor3 = Theme.TextDim})
end)

local SearchHolder, SearchBox = makeSearchBar(Holder, UDim2.new(0, 6, 0, 36), UDim2.new(1, -12, 0, 28), "Command Bar")
...
CMDsF.Position = UDim2.new(0, 6, 0, 68)
CMDsF.Size = UDim2.new(1, -12, 1, -74)
CMDsF.ScrollBarImageColor3 = Theme.Scrollbar
...
Example.BackgroundColor3 = Theme.Surface
Example.BackgroundTransparency = 1
Example.BorderSizePixel = 0
Example.Size = UDim2.new(1, -16, 0, 22)
Example.Visible = false
Example.Font = Theme.FontLight
Example.TextSize = 13
Example.Text = "Example"
Example.TextColor3 = Theme.TextDim
...
SettingsHolder.ScrollBarImageColor3 = Theme.Scrollbar
SettingsHolder.BottomImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
SettingsHolder.CanvasSize = UDim2.new(0, 0, 0, 260)
...
settingsListLayout.Parent = SettingsHolder
applyPadding(SettingsHolder, 8, 8, 8, 8)

local function makeSettingsRow(name, parent)
	...
	row.ZIndex = 10
	applyCorner(row, Theme.CornerSmall)
	...
	table.insert(shade2, row)
	return row
end

local prefixRow = makeSettingsRow("Prefix", SettingsHolder)
PrefixBox = Instance.new("TextBox")
PrefixBox.Name = "PrefixBox"
PrefixBox.Parent = prefixRow
PrefixBox.BackgroundColor3 = Theme.Elevated
PrefixBox.BorderSizePixel = 0
PrefixBox.Position = UDim2.new(1, -42, 0, 4)
PrefixBox.Size = UDim2.new(0, 32, 0, 24)
PrefixBox.Font = Theme.FontBold
PrefixBox.TextSize = 14
PrefixBox.Text = ""
PrefixBox.TextColor3 = Theme.Text
PrefixBox.ZIndex = 11
applyCorner(PrefixBox, Theme.CornerSmall)
table.insert(shade3, PrefixBox)
table.insert(text2, PrefixBox)

Prefix = prefixRow:FindFirstChild("Label")

local stayOpenRow = makeSettingsRow("Keep Menu Open", SettingsHolder)
StayOpen = stayOpenRow:FindFirstChild("Label")
local stayToggle = makeToggle(false, stayOpenRow, UDim2.new(1, -46, 0, 6))
Button = stayToggle
On = stayToggle:FindFirstChild("Knob")

local function makeSettingsButton(name, parent)
	local btn = Instance.new("TextButton")
	btn.Name = name
	btn.Parent = parent
	...
	btn.MouseEnter:Connect(function()
		tween(btn, TInfo.Fast, {BackgroundColor3 = Theme.Elevated})
	end)
	btn.MouseLeave:Connect(function()
		tween(btn, TInfo.Fast, {BackgroundColor3 = Theme.Surface})
	end)
...
ColorsButton = makeSettingsButton("Edit Theme", SettingsHolder)
Keybinds = makeSettingsButton("Edit Keybinds", SettingsHolder)
Aliases = makeSettingsButton("Edit Aliases", SettingsHolder)
Positions = makeSettingsButton("Edit Waypoints", SettingsHolder)
Plugins = makeSettingsButton("Manage Plugins", SettingsHolder)
EventBind = makeSettingsButton("Edit Event Binds", SettingsHolder)
...
applyCorner(Notification, Theme.Corner)
applyStroke(Notification, Theme.Border, 1)
...
applyCorner(NotifAccent, UDim.new(0, 2))

Title_2 = Instance.new("TextLabel")
Title_2.Name = "Title"
Title_2.Parent = Notification
Title_2.BackgroundTransparency = 1
Title_2.Position = UDim2.new(0, 14, 0, 8)
Title_2.Size = UDim2.new(1, -50, 0, 18)
...
Text_2.Position = UDim2.new(0, 14, 0, 28)
Text_2.Size = UDim2.new(1, -24, 1, -34)
Text_2.Font = Theme.FontLight
Text_2.TextSize = 12
...
CloseButton.MouseEnter:Connect(function()
	tween(CloseButton, TInfo.Fast, {TextColor3 = Theme.Error})
end)
CloseButton.MouseLeave:Connect(function()
	tween(CloseButton, TInfo.Fast, {TextColor3 = Theme.TextMuted})
end)
...
PinButton.Position = UDim2.new(1, -52, 0, 4)
PinButton.Size = UDim2.new(0, 24, 0, 24)
PinButton.Text = "📌"
PinButton.Font = Theme.Font
...
Tooltip.Size = UDim2.new(0, 220, 0, 80)
Tooltip.Visible = false
Tooltip.ZIndex = 25
applyCorner(Tooltip, Theme.CornerSmall)
applyStroke(Tooltip, Theme.Border, 1)
...
Title_3.Position = UDim2.new(0, 10, 0, 6)
Title_3.Size = UDim2.new(1, -20, 0, 18)
...
Description.Size = UDim2.new(1, -20, 1, -30)
Description.Font = Theme.FontLight
Description.TextSize = 11
Description.Text = ""
Description.TextColor3 = Theme.TextDim
Description.TextWrapped = true
Description.TextYAlignment = Enum.TextYAlignment.Top
Description.ZIndex = 26
...
IntroBackground.BackgroundColor3 = Theme.Bg
IntroBackground.BorderSizePixel = 0
IntroBackground.Position = UDim2.new(0, 0, 0, 32)
IntroBackground.Size = UDim2.new(1, 0, 1, -32)
IntroBackground.ZIndex = 15
applyCorner(IntroBackground, Theme.Corner)

Logo = Instance.new("ImageLabel")
Logo.Name = "Logo"
Logo.Parent = IntroBackground
...
Credits.Parent = IntroBackground
Credits.BackgroundTransparency = 1
Credits.AnchorPoint = Vector2.new(0.5, 0)
Credits.Position = UDim2.new(0.5, 0, 0.7, 0)
Credits.Size = UDim2.new(0.9, 0, 0, 20)
Credits.Font = Theme.FontLight
Credits.TextSize = 11
Credits.Text = "Edge // Zwolf // Moon // Toon // Peyton // ATP"
Credits.TextColor3 = Theme.TextMuted
Credits.ZIndex = 16

local function makeSubPanel(name, parent)
	...
	applyCorner(panel, Theme.Corner)
	table.insert(shade1, panel)
	...
	header.ZIndex = 11
	applyCorner(header, Theme.CornerSmall)
	...
	local closeBtn = makeButton("Close", UDim2.new(0, 50, 0, 22), UDim2.new(1, -58, 0, 3), header, false)
	...
	listHolder.Position = UDim2.new(0, 4, 0, 32)
	listHolder.Size = UDim2.new(1, -8, 1, -68)
	listHolder.ScrollBarImageColor3 = Theme.Scrollbar
	listHolder.BottomImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
	listHolder.CanvasSize = UDim2.new(0, 0, 0, 0)
	listHolder.MidImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
	listHolder.ScrollBarThickness = 4
	listHolder.TopImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
	listHolder.VerticalScrollBarInset = "Always"
	listHolder.ZIndex = 10
	applyListLayout(listHolder, 2)
	table.insert(scroll, listHolder)
	...
	bottomBar.ZIndex = 10
	applyListLayout(bottomBar, 4, Enum.FillDirection.Horizontal)
	...
	hint.Size = UDim2.new(0.8, 0, 0, 50)
	hint.Font = Enum.Font.GothamItalic
	hint.TextSize = 12
	hint.TextColor3 = Theme.TextMuted
	hint.TextWrapped = true
	hint.ZIndex = 10
	table.insert(text1, hint)

	return panel, listHolder, closeBtn, bottomBar, hint
end

local function makeListItem(text, parent)
	...
	item.ZIndex = 10
	applyCorner(item, Theme.CornerSmall)
	...
	label.ZIndex = 10
	table.insert(text1, label)
	table.insert(shade2, item)

	local delBtn = makeButton("Delete", UDim2.new(0, 44, 0, 20), UDim2.new(1, -50, 0, 3), item, false)
	delBtn.TextSize = 11

	return item, label, delBtn
end

KeybindsFrame, Holder_2, Close, _, _ = makeSubPanel("Keybinds", Settings)
Add = makeButton("Add", UDim2.new(0, 44, 0, 22), nil, KeybindsFrame:FindFirstChild("BottomBar"), true)
Delete = makeButton("Clear", UDim2.new(0, 44, 0, 22), nil, KeybindsFrame:FindFirstChild("BottomBar"), false)

Example_2 = Instance.new("Frame")
Example_2.Name = "Example"
Example_2.Parent = KeybindsFrame
Example_2.BackgroundColor3 = Theme.Surface
Example_2.BorderSizePixel = 0
Example_2.Size = UDim2.new(1, -8, 0, 26)
Example_2.Visible = false
Example_2.ZIndex = 10
applyCorner(Example_2, Theme.CornerSmall)
...
Text_3.Position = UDim2.new(0, 8, 0, 0)
Text_3.Size = UDim2.new(1, -100, 1, 0)
Text_3.Font = Theme.FontLight
Text_3.TextSize = 12
Text_3.Text = "nom"
...
Delete_2 = makeButton("Delete", UDim2.new(0, 44, 0, 20), UDim2.new(1, -50, 0, 3), Example_2, false)
Delete_2.TextSize = 11
...
shadow_2.BackgroundColor3 = Theme.Surface
shadow_2.BorderSizePixel = 0
shadow_2.Size = UDim2.new(1, 0, 0, 28)
shadow_2.ZIndex = 10
applyCorner(shadow_2, Theme.Corner)
...
PopupText_2.Position = UDim2.new(0, 12, 0, 0)
PopupText_2.Size = UDim2.new(1, -40, 1, 0)
PopupText_2.ZIndex = 11
...
Exit_2.Position = UDim2.new(1, -28, 0, 2)
Exit_2.Size = UDim2.new(0, 24, 0, 24)
Exit_2.Text = "✕"
Exit_2.Font = Theme.Font
Exit_2.TextSize = 14
Exit_2.TextColor3 = Theme.TextMuted
Exit_2.ZIndex = 11
...
background_2.BackgroundColor3 = Theme.Bg
background_2.BorderSizePixel = 0
background_2.Position = UDim2.new(0, 0, 0, 28)
background_2.Size = UDim2.new(1, 0, 0, 195)
background_2.ZIndex = 10
applyCorner(background_2, Theme.Corner)
...
Dark_3.Size = UDim2.new(0, 1, 1, -16)
Dark_3.ZIndex = 11
...
Directions.Position = UDim2.new(0, 12, 0, 12)
Directions.Size = UDim2.new(0, 120, 0, 80)
Directions.ZIndex = 10
Directions.Font = Theme.FontLight
...
BindTo = makeButton("Click to bind", UDim2.new(0, 120, 0, 44), UDim2.new(0, 12, 0, 96), background_2, true)
BindTo.TextSize = 13
...
TriggerLabel.Position = UDim2.new(0, 12, 0, 152)
TriggerLabel.Size = UDim2.new(0, 45, 0, 20)
TriggerLabel.ZIndex = 10
TriggerLabel.Font = Theme.FontLight
...
BindTriggerSelect = makeButton("KeyDown", UDim2.new(0, 70, 0, 22), UDim2.new(0, 62, 0, 151), background_2, false)
BindTriggerSelect.TextSize = 11
...
CreateToggle.Position = UDim2.new(0, 158, 0, 12)
CreateToggle.Size = UDim2.new(0, 180, 0, 20)
CreateToggle.ZIndex = 10
CreateToggle.Font = Theme.FontLight
...
local createToggleSwitch = makeToggle(false, background_2, UDim2.new(0, 330, 0, 12))
Button_2 = createToggleSwitch
On_2 = createToggleSwitch:FindFirstChild("Knob")

Cmdbar_2 = Instance.new("TextBox")
Cmdbar_2.Name = "Cmdbar_2"
Cmdbar_2.Parent = background_2
Cmdbar_2.BackgroundColor3 = Theme.Elevated
Cmdbar_2.BorderSizePixel = 0
Cmdbar_2.Position = UDim2.new(0, 158, 0, 42)
Cmdbar_2.Size = UDim2.new(0, 210, 0, 26)
Cmdbar_2.ZIndex = 10
Cmdbar_2.Font = Theme.FontLight
Cmdbar_2.PlaceholderText = "Command"
Cmdbar_2.PlaceholderColor3 = Theme.TextMuted
Cmdbar_2.Text = ""
Cmdbar_2.TextColor3 = Theme.Text
Cmdbar_2.TextSize = 12
Cmdbar_2.TextXAlignment = Enum.TextXAlignment.Left
applyCorner(Cmdbar_2, Theme.CornerSmall)
applyPadding(Cmdbar_2, 0, 0, 8, 0)

Cmdbar_3 = Instance.new("TextBox")
Cmdbar_3.Name = "Cmdbar_3"
Cmdbar_3.Parent = background_2
Cmdbar_3.BackgroundColor3 = Theme.Elevated
Cmdbar_3.BorderSizePixel = 0
Cmdbar_3.Position = UDim2.new(0, 158, 0, 74)
Cmdbar_3.Size = UDim2.new(0, 210, 0, 26)
Cmdbar_3.ZIndex = 10
Cmdbar_3.Font = Theme.FontLight
Cmdbar_3.PlaceholderText = "Command 2"
Cmdbar_3.PlaceholderColor3 = Theme.TextMuted
Cmdbar_3.Text = ""
Cmdbar_3.TextColor3 = Theme.Text
Cmdbar_3.TextSize = 12
Cmdbar_3.TextXAlignment = Enum.TextXAlignment.Left
applyCorner(Cmdbar_3, Theme.CornerSmall)
applyPadding(Cmdbar_3, 0, 0, 8, 0)

Add_2 = makeButton("Add", UDim2.new(0, 50, 0, 22), UDim2.new(0, 318, 0, 108), background_2, true)
Add_2.TextSize = 12
...
Toggles.Position = UDim2.new(0, 158, 0, 136)
Toggles.Size = UDim2.new(0, 210, 0, 50)
Toggles.ZIndex = 10
...
Toggles.ScrollBarImageColor3 = Theme.Scrollbar
...
ClickTP.BackgroundColor3 = Theme.Surface
ClickTP.BorderSizePixel = 0
ClickTP.Size = UDim2.new(1, -4, 0, 22)
ClickTP.ZIndex = 10
ClickTP.Font = Theme.FontLight
ClickTP.Text = "  Click TP (Hold Key & Click)"
ClickTP.TextColor3 = Theme.Text
ClickTP.TextSize = 11
ClickTP.TextXAlignment = Enum.TextXAlignment.Left
applyCorner(ClickTP, Theme.CornerSmall)
table.insert(shade2, ClickTP)
table.insert(text1, ClickTP)

Select = makeButton("Add", UDim2.new(0, 36, 0, 18), UDim2.new(1, -40, 0, 2), ClickTP, false)
Select.TextSize = 10

ClickDelete = Instance.new("TextLabel")
ClickDelete.Name = "Click Delete (Hold Key & Click)"
ClickDelete.Parent = Toggles
ClickDelete.BackgroundColor3 = Theme.Surface
ClickDelete.BorderSizePixel = 0
ClickDelete.Position = UDim2.new(0, 0, 0, 26)
ClickDelete.Size = UDim2.new(1, -4, 0, 22)
ClickDelete.ZIndex = 10
ClickDelete.Font = Theme.FontLight
ClickDelete.Text = "  Click Delete (Hold Key & Click)"
ClickDelete.TextColor3 = Theme.Text
ClickDelete.TextSize = 11
ClickDelete.TextXAlignment = Enum.TextXAlignment.Left
applyCorner(ClickDelete, Theme.CornerSmall)
table.insert(shade2, ClickDelete)
table.insert(text1, ClickDelete)

Select_2 = makeButton("Add", UDim2.new(0, 36, 0, 18), UDim2.new(1, -40, 0, 2), ClickDelete, false)
Select_2.TextSize = 10

PositionsFrame, Holder_4, Close_3, _, _ = makeSubPanel("Waypoints", Settings)
Delete_5 = makeButton("Clear", UDim2.new(0, 44, 0, 22), nil, PositionsFrame:FindFirstChild("BottomBar"), false)
Part = makeButton("Part", UDim2.new(0, 44, 0, 22), nil, PositionsFrame:FindFirstChild("BottomBar"), false)

Example_4 = Instance.new("Frame")
Example_4.Name = "Example"
Example_4.Parent = PositionsFrame
Example_4.BackgroundColor3 = Theme.Surface
Example_4.BorderSizePixel = 0
Example_4.Size = UDim2.new(1, -8, 0, 26)
Example_4.Visible = false
Example_4.ZIndex = 10
applyCorner(Example_4, Theme.CornerSmall)
...
Text_5.Position = UDim2.new(0, 8, 0, 0)
Text_5.Size = UDim2.new(1, -100, 1, 0)
Text_5.Font = Theme.FontLight
Text_5.TextSize = 12
...
Delete_6 = makeButton("Delete", UDim2.new(0, 44, 0, 20), UDim2.new(1, -94, 0, 3), Example_4, false)
Delete_6.TextSize = 11

TP = makeButton("Goto", UDim2.new(0, 40, 0, 20), UDim2.new(1, -50, 0, 3), Example_4, true)
TP.TextSize = 11

PositionsHint = PositionsFrame:FindFirstChild("Hint")
PositionsHint.Text = "Use the 'swp' or 'setwaypoint' command to add a position (NOTE: Part teleports will not save)"

AliasesFrame, Holder_3, Close_2, _, _ = makeSubPanel("Aliases", Settings)
Delete_3 = makeButton("Clear", UDim2.new(0, 44, 0, 22), nil, AliasesFrame:FindFirstChild("BottomBar"), false)

Example_3 = Instance.new("Frame")
Example_3.Name = "Example"
Example_3.Parent = AliasesFrame
Example_3.BackgroundColor3 = Theme.Surface
Example_3.BorderSizePixel = 0
Example_3.Size = UDim2.new(1, -8, 0, 26)
Example_3.Visible = false
Example_3.ZIndex = 10
applyCorner(Example_3, Theme.CornerSmall)
...
Text_4.Position = UDim2.new(0, 8, 0, 0)
Text_4.Size = UDim2.new(1, -60, 1, 0)
Text_4.Font = Theme.FontLight
Text_4.TextSize = 12
Text_4.Text = "honk"
...
Delete_4 = makeButton("Delete", UDim2.new(0, 44, 0, 20), UDim2.new(1, -50, 0, 3), Example_3, false)
Delete_4.TextSize = 11

AliasHint = AliasesFrame:FindFirstChild("Hint")
AliasHint.Text = "Add aliases by using the 'addalias' command"

PluginsFrame, Holder_5, Close_4, _, _ = makeSubPanel("Plugins", Settings)
Add_3 = makeButton("Add", UDim2.new(0, 44, 0, 22), nil, PluginsFrame:FindFirstChild("BottomBar"), true)

Example_5 = Instance.new("Frame")
Example_5.Name = "Example"
Example_5.Parent = PluginsFrame
Example_5.BackgroundColor3 = Theme.Surface
Example_5.BorderSizePixel = 0
Example_5.Size = UDim2.new(1, -8, 0, 26)
Example_5.Visible = false
Example_5.ZIndex = 10
applyCorner(Example_5, Theme.CornerSmall)
...
Text_6.Position = UDim2.new(0, 8, 0, 0)
Text_6.Size = UDim2.new(1, -60, 1, 0)
Text_6.Font = Theme.FontLight
Text_6.TextSize = 12
...
Delete_7 = makeButton("Delete", UDim2.new(0, 44, 0, 20), UDim2.new(1, -50, 0, 3), Example_5, false)
Delete_7.TextSize = 11

PluginsHint = PluginsFrame:FindFirstChild("Hint")
...
shadow_3.BackgroundColor3 = Theme.Surface
shadow_3.BorderSizePixel = 0
shadow_3.Size = UDim2.new(1, 0, 0, 28)
shadow_3.ZIndex = 10
applyCorner(shadow_3, Theme.Corner)
...
PopupText_3.Position = UDim2.new(0, 12, 0, 0)
PopupText_3.Size = UDim2.new(1, -40, 1, 0)
PopupText_3.ZIndex = 11
...
Exit_3.Position = UDim2.new(1, -28, 0, 2)
Exit_3.Size = UDim2.new(0, 24, 0, 24)
Exit_3.Text = "✕"
Exit_3.Font = Theme.Font
Exit_3.TextSize = 14
Exit_3.TextColor3 = Theme.TextMuted
Exit_3.ZIndex = 11
...
background_3.BackgroundColor3 = Theme.Bg
background_3.BorderSizePixel = 0
background_3.Position = UDim2.new(0, 0, 0, 28)
background_3.Size = UDim2.new(1, 0, 0, 170)
background_3.ZIndex = 10
applyCorner(background_3, Theme.Corner)
...
Dark_2.Position = UDim2.new(0, 230, 0, 8)
Dark_2.Size = UDim2.new(0, 1, 1, -16)
Dark_2.ZIndex = 11
...
Img.Position = UDim2.new(0, 250, 0, 8)
Img.Size = UDim2.new(0, 110, 0, 90)
Img.Image = "rbxassetid://4113050383"
Img.ZIndex = 11

AddPlugin = makeButton("Add Plugin", UDim2.new(0, 120, 0, 36), UDim2.new(0, 245, 0, 110), background_3, true)

About = Instance.new("TextLabel")
About.Name = "About"
About.Parent = background_3
About.BackgroundTransparency = 1
About.Position = UDim2.new(0, 14, 0, 12)
About.Size = UDim2.new(0, 200, 0, 45)
About.Font = Theme.FontLight
About.TextSize = 12
...
Directions_2.Position = UDim2.new(0, 14, 0, 60)
Directions_2.Size = UDim2.new(0, 200, 0, 40)
Directions_2.Font = Theme.FontLight
...
FileName.BackgroundColor3 = Theme.Elevated
FileName.BorderSizePixel = 0
FileName.Position = UDim2.new(0, 14, 0, 110)
FileName.Size = UDim2.new(0, 200, 0, 40)
FileName.Font = Theme.FontLight
FileName.TextSize = 12
FileName.Text = ""
FileName.PlaceholderText = "Plugin File Name"
FileName.PlaceholderColor3 = Theme.TextMuted
FileName.TextColor3 = Theme.Text
FileName.ZIndex = 10
applyCorner(FileName, Theme.CornerSmall)
applyPadding(FileName, 0, 0, 8, 0)
...
shadow_4.BackgroundColor3 = Theme.Surface
shadow_4.BorderSizePixel = 0
shadow_4.Size = UDim2.new(1, 0, 0, 28)
shadow_4.ZIndex = 10
applyCorner(shadow_4, Theme.Corner)
...
PopupText_5.Position = UDim2.new(0, 12, 0, 0)
PopupText_5.Size = UDim2.new(1, -40, 1, 0)
PopupText_5.ZIndex = 11
...
Exit_4.Position = UDim2.new(1, -28, 0, 2)
Exit_4.Size = UDim2.new(0, 24, 0, 24)
Exit_4.Text = "✕"
Exit_4.Font = Theme.Font
Exit_4.TextSize = 14
Exit_4.TextColor3 = Theme.TextMuted
Exit_4.ZIndex = 11
...
background_4.BackgroundColor3 = Theme.Bg
background_4.BorderSizePixel = 0
background_4.Position = UDim2.new(0, 0, 0, 28)
background_4.Size = UDim2.new(1, 0, 0, 110)
background_4.ZIndex = 10
applyCorner(background_4, Theme.Corner)
...
Directions_3.Position = UDim2.new(0, 14, 0, 14)
Directions_3.Size = UDim2.new(1, -28, 0, 32)
Directions_3.Font = Theme.FontLight
Directions_3.TextSize = 12
Directions_3.Text = 'Click on a part and then click "Select Part" below to set it as a teleport location'
...
ChoosePart = makeButton("Select Part", UDim2.new(0, 90, 0, 28), UDim2.new(0.5, -100, 0, 52), background_4, true)
CopyPath = makeButton("Copy Path", UDim2.new(0, 90, 0, 28), UDim2.new(0.5, 10, 0, 52), background_4, false)

Path = Instance.new("TextLabel")
Path.Name = "Path"
Path.Parent = background_4
Path.BackgroundTransparency = 1
Path.Position = UDim2.new(0, 14, 0, 88)
Path.Size = UDim2.new(1, -28, 0, 16)
Path.Font = Enum.Font.GothamItalic
Path.TextSize = 10
Path.Text = ""
Path.TextColor3 = Theme.TextMuted
...
logs.Size = UDim2.new(0, 350, 0, 20)
logs.ZIndex = 10

shadow = Instance.new("Frame")
shadow.Name = "shadow"
shadow.Parent = logs
shadow.BackgroundColor3 = Theme.Surface
shadow.BorderSizePixel = 0
shadow.Size = UDim2.new(1, 0, 0, 28)
shadow.ZIndex = 10
applyCorner(shadow, Theme.Corner)
...
PopupText.Position = UDim2.new(0, 12, 0, 0)
PopupText.Size = UDim2.new(1, -60, 1, 0)
PopupText.ZIndex = 11
...
Hide.Position = UDim2.new(1, -52, 0, 2)
Hide.Size = UDim2.new(0, 24, 0, 24)
Hide.Text = "—"
Hide.Font = Theme.Font
Hide.TextSize = 14
...
Exit.Position = UDim2.new(1, -28, 0, 2)
Exit.Size = UDim2.new(0, 24, 0, 24)
Exit.Text = "✕"
Exit.Font = Theme.Font
Exit.TextSize = 14
Exit.TextColor3 = Theme.TextMuted
Exit.ZIndex = 11
...
background.Position = UDim2.new(0, 0, 0, 28)
background.Size = UDim2.new(1, 0, 0, 250)
background.ZIndex = 10
applyCorner(background, Theme.Corner)
table.insert(shade1, background)

local logTabHolder, logPages = makeTabs({"Chat Logs", "Join Logs"}, background, UDim2.new(0, 6, 0, 6), UDim2.new(1, -12, 1, -40))
...
Clear = makeButton("Clear", UDim2.new(0, 50, 0, 22), UDim2.new(0, 6, 1, -28), chat, false)
Clear.TextSize = 11

Toggle = makeButton("Disabled", UDim2.new(0, 66, 0, 22), UDim2.new(0, 60, 1, -28), chat, false)
Toggle.TextSize = 11

SaveChatlogs = makeButton("Save To .txt", UDim2.new(0, 80, 0, 22), UDim2.new(1, -86, 1, -28), chat, false)
SaveChatlogs.TextSize = 11
...
scroll_2.Position = UDim2.new(0, 2, 0, 2)
scroll_2.Size = UDim2.new(1, -4, 1, -30)
scroll_2.ZIndex = 10
...
scroll_2.ScrollBarImageColor3 = Theme.Scrollbar
scroll_2.TopImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
table.insert(scroll, scroll_2)

Clear_2 = makeButton("Clear", UDim2.new(0, 50, 0, 22), UDim2.new(0, 6, 1, -28), join, false)
Clear_2.TextSize = 11

Toggle_2 = makeButton("Disabled", UDim2.new(0, 66, 0, 22), UDim2.new(0, 60, 1, -28), join, false)
...
scroll_3.Position = UDim2.new(0, 2, 0, 2)
scroll_3.Size = UDim2.new(1, -4, 1, -30)
scroll_3.ZIndex = 10
scroll_3.BottomImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
scroll_3.CanvasSize = UDim2.new(0, 0, 0, 10)
scroll_3.ScrollBarThickness = 4
scroll_3.ScrollBarImageColor3 = Theme.Scrollbar
...
selectChat = logTabHolder
selectJoin = logTabHolder
